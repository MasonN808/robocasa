...
usage() {
  cat <<'EOF'
Usage: sbatch scripts/sbatch/sbatch_image_processing_gpuH200x8_1node_task_cleanup.sh <run_timestamp> [sweep_cli_args...]
...
Example:
  sbatch scripts/sbatch/sbatch_image_processing_gpuH200x8_1node_task_cleanup.sh 20260401T000000Z
