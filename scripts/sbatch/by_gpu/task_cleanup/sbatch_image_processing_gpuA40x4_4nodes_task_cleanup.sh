...
usage() {
  cat <<'EOF'
Usage: sbatch scripts/sbatch/sbatch_image_processing_gpuA40x4_4nodes_task_cleanup.sh <run_timestamp> [sweep_cli_args...]
...
Example:
  sbatch scripts/sbatch/sbatch_image_processing_gpuA40x4_4nodes_task_cleanup.sh 20260401T000000Z
