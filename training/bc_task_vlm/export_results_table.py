...
RUNS = [
    ...
    # "baseline *" is the model's TRUE interface (native tool calls, no forced
    # JSON) and is the headline row; the forced-JSON runs are interface controls.
    ("Qwen3-VL-8B base", "baseline *", "heldout_trajectories", "qwen3vl_8b_base_nativefmt__heldout_trajectories"),
    ("Qwen3-VL-8B base", "baseline *", "heldout_tasks", "qwen3vl_8b_base_nativefmt__heldout_tasks"),
    ("Qwen3-VL-8B base", "baseline (forced-JSON control)", "heldout_trajectories", "qwen3vl_8b_base_tc__heldout_trajectories"),
    ("Qwen3-VL-8B base", "baseline (forced-JSON control)", "heldout_tasks", "qwen3vl_8b_base_tc__heldout_tasks"),
    ...
    ("Qwen3-VL-8B base", "+task spec", "heldout_tasks", "qwen3vl_8b_base_spec__heldout_tasks"),
    ("Qwen3-VL-8B SFT", "+task spec", "heldout_trajectories", "qwen3vl_8b_sft_spec__heldout_trajectories"),
    ("Qwen3-VL-8B SFT", "+task spec", "heldout_tasks", "qwen3vl_8b_sft_spec__heldout_tasks"),
    ("Qwen3-VL-8B base", "+few-shot", "heldout_trajectories", "qwen3vl_8b_base_fewshot__heldout_trajectories"),
    ("Qwen3-VL-8B base", "+few-shot", "heldout_tasks", "qwen3vl_8b_base_fewshot__heldout_tasks"),
    ("Qwen3-VL-8B SFT", "+few-shot", "heldout_trajectories", "qwen3vl_8b_sft_fewshot__heldout_trajectories"),
    ("Qwen3-VL-8B SFT", "+few-shot", "heldout_tasks", "qwen3vl_8b_sft_fewshot__heldout_tasks"),
    ("Qwen3-VL-8B base", "+spec+few-shot", "heldout_trajectories", "qwen3vl_8b_base_spec_fewshot__heldout_trajectories"),
    ("Qwen3-VL-8B base", "+spec+few-shot", "heldout_tasks", "qwen3vl_8b_base_spec_fewshot__heldout_tasks"),
    ("Qwen3-VL-8B SFT", "+spec+few-shot", "heldout_trajectories", "qwen3vl_8b_sft_spec_fewshot__heldout_trajectories"),
    ("Qwen3-VL-8B SFT", "+spec+few-shot", "heldout_tasks", "qwen3vl_8b_sft_spec_fewshot__heldout_tasks"),
